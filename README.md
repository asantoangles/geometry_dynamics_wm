...
To facilitate reproducibility, data is available at the OSF repository https://osf.io/hk7yc. We provide the neural activity matrices (X) used to compute the neural subspaces. 
